...
if calculate:
    ...
    if fatalities == "Billions":
        ...
        st.write("Global lockdown required.")
        ...
        st.write("Aftershock waves and atmospheric effects expected.")
    ...
    st.success("✅ Simulation complete! Adjust parameters to explore more impacts.")
